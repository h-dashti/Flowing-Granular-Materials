...
def plotXY(plt, XY_arr, lab_arr, xlabel, ylabel, txt, oname, \
...
def plot_logxy(plt, x, y,  xlabel, ylabel, label, txt, oname, calc_slope):
	...
	if calc_slope:
		slope, intercept, std_err = loglog_slope(x, y)
		plt.loglog(x, y)
