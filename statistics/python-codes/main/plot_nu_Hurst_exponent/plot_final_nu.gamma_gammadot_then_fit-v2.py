...
def plot_nu(ax,
    ...
    txt = r'$\quad a={:.3f}, b={:.3f}$'.format(popt[1], popt[0])
    txt2 = r'$\; \delta a={:.4f}, \delta b={:.4f}$'.format(perr[1], perr[0])
    ax.plot(xn, fit,                 
        label=r'$a \, \dot{\gamma}^b$' + txt + txt2,
        color='k',
        ls='-',
...
if __name__ == '__main__':
    ...
    plot_nu(ax, plt_xlabel=False, plt_ylabel=False)
    plot_gamma(ax, )
    
    plt.savefig('nu_gammadpt_temp.pdf',
