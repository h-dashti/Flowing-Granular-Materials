...
def get_data(fpath):
    ...
    for d in data:
        ...
        res[N][gammadot] = (allf_ave, sqrt(allf_var))
...
def plot(ax,
         ...
         plt_ylabel=True,
         sub_indx_fit = None,
         what_am_i_doing = 'plotting allf_var_relative by rheology',
         ):
    ...
    if plt_ylabel:
        ax.set_ylabel(r'$\sigma_f/f_{av}$', fontsize=fntsize)
