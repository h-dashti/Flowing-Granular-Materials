...
def get_data(idir_all, idir_part, ix, iy, N_arr, gammadot_arr, phi):
    ...
    for N in N_arr:
        ...
        for g in gammadot_arr:
            ...
            pinfatfc = interp(x, y, fc)
            
            info[N][g_st] = {'L': L, 'fc': fc, 'Pinf_at_fc': pinfatfc }
...
def plot_qunatity_versus_N(ax, data, gammadot_arr, 
    ...
    for g in gammadot_arr:
        ...
        if slope:
            ...
            print('WARNING: the err_multiple for gammadot={}'.format(g_st))
            
            err_multiple, err_shift = 1.2, 0.010535346387/2
            
            final_error = expo_err * err_multiple + err_shift
...
if __name__ == '__main__':
    ...
    plot_qunatity_versus_N(ax, info, gammadot_arr,
                           ...
                           ncol = 2,
                           xlabel = '$N$',
                           ylabel = r'$P_\infty(f_t = f_c)$'
                           )
    
    
    plt.savefig('Pinf_at_fc.pdf', pad_inches=0.02, bbox_inches='tight')
